              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    tenant.isConnected ? "bg-green-500/10" : "bg-gray-500/10"
                  )}>
                    <Server className={cn(
                      "h-4 w-4",
                      tenant.isConnected ? "text-green-500" : "text-gray-500"
                    )} />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                      ...
                      {tenant.lastSyncAt && (
                        <span>
                          Synced {formatDistanceToNow(new Date(tenant.lastSyncAt), { addSuffix: true })}
                        </span>
                      )}
                    </div>
                  </div>
