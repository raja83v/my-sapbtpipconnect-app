---
title: Organize assets with Labels in CPI Connect
updatedAt: 2025-05-09
summary: Learn how CPI Connect labels help you organize pages, assets, and client deliverables inside a workspace.
author: codehagen
categories:
  - getting-started
related:
...
Labels are a lightweight way to group content in CPI Connect. You can attach labels to pages, sections, and media so busy workspaces stay searchable.

<Image
  alt="Using labels to organize pages in CPI Connect"
...
If the label already exists you can select it. Otherwise press `Enter ↩` to create a new one and CPI Connect will suggest a color automatically.
...
Want automations or shared label presets across clients? Reach out to the CPI Connect team—we’d love to hear how you’re organizing your work.
