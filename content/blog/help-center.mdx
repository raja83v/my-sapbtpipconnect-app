---
title: Introducing the CPI Connect Help Center
publishedAt: 2025-05-09
summary: Meet the CPI Connect Help Center—your hub for guided workflows, workspace tips, and launch best practices.
...
Today, we're excited to launch the [CPI Connect Help Center](/help)—a single destination for workspace setup guides, AI workflows, and troubleshooting tips.
...
## Lightning-fast search, everywhere in CPI Connect
...
<Image
  alt="Command menu search inside the CPI Connect Help Center"
  src="https://imagedelivery.net/r-6-yk-gGPtjfbIST9-8uA/de9cf569-f767-4d0c-7b3e-21605769be00/public"
  width={1607}
  height={946}
/>

Best of all, search is available anywhere inside CPI Connect—workspace, editor, or Help Center. Hit `⌘K` (`Ctrl+K` on Windows) to open the command palette and search articles without losing focus.
